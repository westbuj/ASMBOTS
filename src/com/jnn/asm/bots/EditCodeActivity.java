...
public class EditCodeActivity extends Activity implements OnClickListener {
	...
	static ComboBox op1=null;
	static ComboBox op2=null;
	static ComboBox op3=null;
	static ComboBox op4=null;
	static ComboBox op5=null;
	static ComboBox command =null;
	static TextView cmdHelp=null;
	static TextView op1Prompt=null;
	static TextView op2Prompt=null;
	static TextView op3Prompt=null;
	static TextView op4Prompt=null;
	static TextView op5Prompt=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//        command.setAdapter(ca);
		        ...
		        if (thisCommand == null)
		    		...
		    		{cmdHelp.setText(thisCommand.getCommandHelp());
		    		 setOpts(thisCommand);
		    		}
	...
	public static void setOpts(COMMANDS c){
		if (c.getNumParams() >= 1)
