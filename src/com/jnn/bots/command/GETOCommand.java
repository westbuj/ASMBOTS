...
public class GETOCommand implements COMMANDS {

	public static String[] paramHelp = { "Opponent ID"};
	...
	public boolean operate(Bot b,ArrayList<String> params) {
		...
		Team targetTeam=null;
			...
			//b.
			b.regs.get("RET1").mValue= CMath.revX(targetTeam.players.get((int) op1-1).regs.get("POSX").mValue);
			b.regs.get("RET2").mValue= CMath.revY(targetTeam.players.get((int) op1-1).regs.get("POSY").mValue);
			b.regs.get("RET3").mValue= CMath.revA(targetTeam.players.get((int) op1-1).regs.get("DIR").mValue);
			b.regs.get("RET4").mValue= CMath.revX(targetTeam.players.get((int) op1-1).regs.get("SPD").mValue);
	...
	public String getCommandHelp() {
		// TODO Auto-generated method stub
		return "GETO 1 - Returns position, heading, and speed of opposing bot to RET1, RET2, RET3, and RET4";
	}
