	 ...
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	       ...
	       // setContentView(R.layout.main);
	        ...
	        View thisView = inflater.inflate(R.layout.local_web_view, null);
	        setContentView(thisView);
	           
	               
	        contentView = (WebView) thisView.findViewById(R.id.webview);
	          
	       // loadDataWithBaseURL (String baseUrl, String data, String mimeType, String encoding, String historyUrl)
 	  //      thisView.setBackgroundResource(R.drawable.field);
	        contentView.loadUrl("file:///android_asset/story.html");
